...
public class MainActivity extends FragmentActivity
    ...
    void initCognito() {
        ...
        Auth.Builder builder = new Auth.Builder().setAppClientId(getString(R.string.cognito_client_id))
                ...
                .setUserPoolId(getString(R.string.pool_id))
                .setSignInRedirect(getString(R.string.sign_in_redirect))
                .setSignOutRedirect(getString(R.string.sign_out_redirect));
        this.auth = builder.build();
        appRedirect = Uri.parse(getString(R.string.sign_in_redirect));
    }
